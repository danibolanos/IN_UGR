...
if __name__ == '__main__': 
  ...
  '''
  print("------ RandomForest...")
  rfm = RandomForestClassifier(max_features = 'sqrt', n_estimators=200, max_depth=23, random_state=5)
  ...
  '''
  print("------ CatBoost...")
  cbc = CatBoostClassifier(iterations=80, learning_rate=1, depth=15,
                           loss_function='MultiClass', random_seed=76592621)
  # Hago la validación cruzada para el algoritmo
  cbc, y_train_clf, y_test_clf = validacion_cruzada(cbc, X, y)
  print("------ Generando submission...")
  submission(cbc)
  '''
  ...
  clf = RandomizedSearchCV(fit_alg, n_iter=4, cv=5, scoring='f1_micro', param_distributions=param_dist, n_jobs=2)
  clf = clf.fit(X,y)
